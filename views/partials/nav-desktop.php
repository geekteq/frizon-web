...
<aside class="app-sidebar" style="padding:var(--space-4);">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="/adm/frizze" class="sidebar-nav__item <?= str_starts_with($currentPath, '/adm/frizze') ? 'sidebar-nav__item--active' : '' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9L18.4 10l-2.1-3.2A2 2 0 0 0 14.6 6H7.4a2 2 0 0 0-1.7.9L3.6 10l-2.1 1.1A2 2 0 0 0 0 13v3c0 .6.4 1 1 1h2"/><circle cx="6" cy="17" r="2"/><circle cx="17" cy="17" r="2"/><path d="M8 10h7"/></svg>
            Frizze
        </a>
