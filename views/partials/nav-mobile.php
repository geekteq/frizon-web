...
<nav class="bottom-nav" aria-label="Huvudnavigation">
    ...
    <a href="/platser/ny" class="bottom-nav__fab" aria-label="Spara plats här">
    ...
    <a href="/listor" class="bottom-nav__item <?= str_starts_with($currentPath, '/listor') ? 'bottom-nav__item--active' : '' ?>" aria-label="Listor">
