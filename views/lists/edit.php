<div class="page-header mb-4">
    <a href="/adm/listor/<?= $list['id'] ?>" class="btn-ghost btn--sm">&larr; Tillbaka</a>
    <h2>Redigera lista</h2>
</div>

<form method="POST" action="/adm/listor/<?= $list['id'] ?>" style="max-width:var(--form-max-width);">
    ...
    <div class="flex gap-3">
        ...
        <a href="/adm/listor/<?= $list['id'] ?>" class="btn btn-ghost">Avbryt</a>
    </div>
</form>
